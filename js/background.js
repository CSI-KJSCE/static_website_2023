...
function onLoad() {
    ...
    document.querySelector("#anmbg").appendChild(svg);
...
function refresh() {
    randomize();
    for (var i = 0; i < document.querySelector("#anmbg svg").childNodes.length; i++) {
        var polygon = document.querySelector("#anmbg svg").childNodes[i];
...
function onResize() {
    document.querySelector("#anmbg svg").remove();
